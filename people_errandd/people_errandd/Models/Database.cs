...
namespace people_errandd.Models
{
    public class Database
    {
        ...
        {
             return _database.QueryAsync<WorkRecordModels>("SELECT * FROM [WorkRecordModels] WHERE [time] LIKE '%"+Record.Date.ToString("d")+"%'");
        ...
        {
            return _database.QueryAsync<DayOffRecordModels>("SELECT * FROM [DayOffRecordModels] WHERE [Date] LIKE '%" + Record.Date.ToString("d") + "%'");
        ...
        {
            return _database.QueryAsync<GoOutRecordModels>("SELECT * FROM [GoOutRecordModels] WHERE [Date] LIKE '%" + Record.Date.ToString("d") + "%'");
